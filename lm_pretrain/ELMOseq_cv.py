...
def main():
    grid_params = {
            ...
            "num_units":  [256, 256, 256, 256, 256],
            "dropout":    [.3,  .3,  .3,  .3,  .3],
            "var_dropout":[.3,  .3,  .3,  .3,  .3],
            "num_epochs": [250, 250, 250, 250, 250],
            "sub":        ["1", "2", "3", "4", "5"],
            }
    ...
    def get_hparams(ind):
        bdrnn = tf.contrib.training.HParams(
            ...
            logdir="/home/dillon/models/thesis/bdrnn/pre/ELMOseq/"+logdir_suffix(ind),
            logging=True,
            freeze_bdlm=True,
            input_style="ELMO_seq",
            )
        return bdrnn
